    ...
    <main className="">
      ...
      >
        {({ isSubmitting, setFieldValue }) => (
          <Form style={{padding:"120px",backgroundImage:`url(${ImageURL})`}} className="flex flex-col items-center justify-center">
            <h1 style={{color:"orange"}} className="text-3xl font-bold mb-4">Add new product</h1>
            ...
            <div style={{backgroundColor:"orange",padding:"30px"}} className="flex flex-col mb-4">
